...
<img src="../../static/img/Removed_2_1.gif" width="500">
...
> **BE CAREFUL!** You are working with an electric device. Make sure that you don’t touch the non insulated part of the wires, and you don’t let the wires touch each other! The best practice is, if you add a little electrical tape to the wire ends as soon as you can, until you need them.
...
4. Decision time.
    ...
    <img src="../../static/img/Removed_2_2.gif" width="500">
    ...
    <img src="../../static/img/Stayon_2_2.gif" width="500">
...
5. Add the connector to the free wires.
    ...
    2. If it’s a 2 wire system, connect the two wires to the purple terminal places, with the number 2 written on them (it doesn't matter, which wire goes to which of the 2 places)!  
    <img src="../../static/img/Removed_2_5.gif" width="500">
...
<img src="../../static/img/Removed_2_4.gif" width="500">
...
7. Plug in the connector into the Phonein.  
    <img src="../../static/img/Removed_2_6.gif" width="500">
